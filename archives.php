...
?>
                    <tr>
                      ...
                      <td class="text-danger">Archivé</td>
                      <?php } else { ?>
                      <td></td>
                      <?php } ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="modal-footer">
                    ...
                    <input type="text" id="selectedIdToRestaure" name="selectedIdToRestaure" value="">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Annuler</button>
                    <form action="" method="post">
                    <input type="text" id="selectedIdToDelete" name="selectedIdToDelete" value="">
                      <input type="submit" name="delete" id="delete" value="Confirmer la suppression définitive" class="btn btn-danger">
                    </form>
                  </div>
                </div>
            </div>
...
$(document).ready(function() {
  ...
  $('#viewCowModal<?= $donnees['id']?>').on('show.bs.modal', function (e) {
    history.pushState({key: '<?= $donnees['id']?>'}, 'Numéro <?= $donnees['id']?>', '#viewCowModal<?= $donnees['id']?>');
  })

  $('#viewCowModal<?= $donnees['id']?>').on('hide.bs.modal', function (e) {
    history.pushState({key: 'milkow'}, '', 'archives');
  })
